...
namespace System
{
    ...
    public class AggregateException : Exception
    {
        ...
        public AggregateException()
            : base(Strings.AggregateException_ctor_DefaultMessage)
        {
        ...
        public AggregateException(IEnumerable<Exception> innerExceptions) :
            this(Strings.AggregateException_ctor_DefaultMessage, innerExceptions)
        {
        }
            ...
            : base(message, innerExceptions != null && innerExceptions.Count > 0 ? innerExceptions[0] : null)
        {
            ...
            for (int i = 0; i < exceptionsCopy.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(Strings.AggregateException_ctor_InnerExceptionNull);
                }
            }
        ...
        public override Exception GetBaseException()
        {
            ...
            {
                back = back.InnerException; // this can be any exception type
